...
public class ForRepairManager_hand extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ForRepairManager_hand() {
        super();
...
//		request.setAttribute("repairNo", repairNo);
		RequestDispatcher rd = request.getRequestDispatcher("html/forRepair_hand/forRepair_frame_footerh.jsp");//需要修改
