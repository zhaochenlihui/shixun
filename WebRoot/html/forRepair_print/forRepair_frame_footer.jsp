...
<body>
<form action="***" method=" post" name="forRepair_frame_footer" onsubmit="return print()">
   <% CustomerSure customersure = (CustomerSure)request.getAttribute("customersure"); %>
	...
	<table align="center" width=780>
		<tr>
			<th align="right"><a href="forRepair_frame_header.jsp"><input type="button" name="print" value="打印"></a></th>
		</tr>
	</table>
	</form>
</body>
